...
| 08 Chihuahua                                                             |          0          |          0          |     0      |
| [09 Ciudad de México](https://euphonious-crostata-930ad9.netlify.app)    |          1          |          1          |     1      |
...
## [Validación de los hotspots de dengue y los escenarios epidemiológicos ]{style="color:#003300;"}
<hr style="height:2px;border-width:0;color:#330019;background-color:#330019">
...
## [Perspectivas de los Escenarios Epidemiológicos con la Transmisión Persistente ]{style="color:#003300;"}
<hr style="height:2px;border-width:0;color:#330019;background-color:#330019">

   - Geocodificar los casos de los estados con mucha localidades hotspots del vector pero con pocas localidades con escenarios.

   - Actualizar los hotspots y los escenarios epidemiológicos con los hexágonos.

   - Evaluar realizar la predicción de los huevos sobre los hexagonos.

   - Validar los hotspots y los escenarios epidemiológicos con **casos**, **adultos**, **huevos**, **RO**, & **FOI**.
