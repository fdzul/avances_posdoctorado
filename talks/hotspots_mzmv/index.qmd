...
::: grid-item
```{r aedes, out.height="550%", out.width="110%"}
#| echo: false
#| output: true
aedes <- terra::rast("/Users/fdzul/Dropbox/posdoctorado_INSP/proyectos/risk_mzmv/11.output/pred_ae_aegypti.tif")
ggplot2::ggplot() +
    tidyterra::geom_spatraster(data = aedes,
                               ggplot2::aes(fill = mean)) +
    tidyterra::scale_fill_whitebox_c("Probabilidad",
                                     palette = "muted",
                                     n.breaks = 10,
                                     #alpha = 0.5,
...
::: grid-item
```{r den_impor, out.height="550%", out.width="110%"}
#| echo: false
#| output: true
den <- terra::rast("/Users/fdzul/Dropbox/posdoctorado_INSP/proyectos/risk_mzmv/11.output/pred_dengue.tif")
ggplot2::ggplot() +
    tidyterra::geom_spatraster(data = den,
                               ggplot2::aes(fill = mean)) +
    tidyterra::scale_fill_whitebox_c("Probabilidad",
                                     palette = "muted",
                                     n.breaks = 10,
...
::: grid-item
```{r risk, echo= FALSE, out.height="550%", out.width="110%"}
